...
$goals = [
    'week' => [
        'title' => 'week...',
        'one' => 'Use PHP and Wordpress CMS to work on some old and new projects. This would give me some good pratice and create some portfolio ready projects.',
        'two' => 'Write more blog post, specifically talking about the PHP CRUD project',
        'three' => 'Start making graphics. I want to look into blender and make some 3D models.',
        'four' => 'Keep an eye on my portfolio page and search for external feedback.',
        'five' => 'Meet with Derek as much as possible.',
    ],
    'month' => [
        'title' => 'month...',
        'one' => 'Prepare for incoming lessons about Javascript.',
        'two' => 'Use all the tools we’ve gained so far to delelop new ideas and projects.',

        'three' => 'Be able to use PHP comfortably in most scenarios.',
        'four' => 'Develop current projects for display on portfolio.',
        'five' => 'Plan some meditation to avoid burnout.',
    ...
    'course' => [
        ...
        'four' => 'Continue to learn new skills. New frameworks? 3D graphics? Game Design? More interactive graphics?',
